...
xhrRequest.open('get', 'https://www.superheroapi.com/api.php/102418315822625/'+heroId);
xhrRequest.send();
//function to fill all the superhero data
...
//function to show other names of hero
...
function showToastMessage(added){
      var message;
      if(added){
          message = "Added your Superhero to Favourites Sucessfully"
      }else{
...
//on clicking any favourite button
